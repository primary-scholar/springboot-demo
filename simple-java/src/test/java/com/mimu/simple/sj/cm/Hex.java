...
public class Hex {
     ...
     *
     * @param data        byte[]
     * @param toLowerCase <code>true</code> 传换成小写 <code>false</code> 传换成大写
     * @return 十六进制String
     */
     ...
     * @param src 十六进制char[]
     * @return byte[]
     * @throws RuntimeException 如果源十六进制字符数组是个奇怪的长度，将抛出运行时异�?
     */
     ...
     * @return
     * @throws RuntimeException 当ch不是合法的十六进制字符时，抛出运行时异常
     */
