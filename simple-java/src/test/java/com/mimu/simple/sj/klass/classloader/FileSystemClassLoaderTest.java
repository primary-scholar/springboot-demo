package com.mimu.simple.sj.klass.classloader;
...
public class FileSystemClassLoaderTest {
    ...
    public void ConstrastOneTwo_Two() throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException {
        ...
        System.out.println(clazzTwo.getClassLoader());
        System.out.println(com.mimu.simple.sj.klass.classloader.SameClass.class.getClassLoader());
        /**
         * Attention!!!
         ...
         */
        Method setSameClazzTwo = clazzTwo.getDeclaredMethod(setSameClass, com.mimu.simple.sj.klass.classloader.SameClass.class);
    }
